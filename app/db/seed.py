...
ALARM_CODES = [
    ...
    # LS iG5A 인버터 알람코드
    ("LS","SV-iG5A","OC1","가속 중 과전류","가속 중 출력전류가 정격전류의 200% 초과","가속시간 연장, 부하 점검, 배선 확인"),
    ("LS","SV-iG5A","OC2","정속 중 과전류","정속운전 중 과전류","부하 점검, 모터 절연 측정"),
    ("LS","SV-iG5A","OC3","감속 중 과전류","감속 중 과전류","감속시간 연장, 제동저항 추가"),
    ("LS","SV-iG5A","OV","과전압","DC 링크 전압 과대","감속시간 연장, 제동저항 추가, 전원전압 확인"),
    ("LS","SV-iG5A","LV","저전압","DC 링크 전압 부족","전원전압 확인, 전원배선 점검"),
    ("LS","SV-iG5A","GF","지락","출력측 지락 발생","모터 및 출력배선 절연 측정"),
    ("LS","SV-iG5A","OH1","인버터 과열","인버터 내부 과열","주변온도 확인, 통풍 개선, 부하율 확인"),
    ("LS","SV-iG5A","OH2","모터 과열","모터 과열 보호 동작","부하 경감, 냉각 개선"),
    ("LS","SV-iG5A","OL","과부하","인버터 과부하","부하 경감, 인버터 용량 재검토"),
    ("LS","SV-iG5A","EEP","EEPROM 이상","파라미터 저장 오류","파라미터 초기화 후 재설정"),
    ("LS","SV-iG5A","HW","하드웨어 이상","내부 하드웨어 이상","인버터 교체"),
    ("LS","SV-iG5A","CON","옵션 통신 이상","통신 옵션 카드 이상","통신 배선 및 옵션카드 점검"),
    ("LS","SV-iG5A","FAN","냉각팬 이상","냉각팬 고장","냉각팬 교체"),
    ("LS","SV-iG5A","PO","출력결상","인버터 출력 결상","출력 배선 및 모터 확인"),
]
